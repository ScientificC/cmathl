...
static __CML_INLINE void downheap(void *data, const size_t size, const size_t N, size_t k, cml_comparison_fn_t compare);
...
static __CML_INLINE void
downheap(void *data, const size_t size, const size_t N, size_t k,
...
void
cml_heapsort(void *data, size_t count, size_t size, cml_comparison_fn_t compare)
{
