...
int cml_block_int_fprintf(FILE *stream, const cml_block_int_t *b, const int *format);
...
int cml_block_int_raw_fprintf(FILE *stream, const int *b, const size_t n, const size_t stride, const int *format);
