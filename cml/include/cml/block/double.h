...
int cml_block_fprintf(FILE *stream, const cml_block_t *b, const double *format);
...
int cml_block_raw_fprintf(FILE *stream, const double *b, const size_t n, const size_t stride, const double *format);
