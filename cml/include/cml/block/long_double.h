...
int cml_block_long_double_fprintf(FILE *stream, const cml_block_long_double_t *b, const char *format);
...
int cml_block_long_double_raw_fprintf(FILE *stream, const long double *b, const size_t n, const size_t stride, const char *format);
