...
int cml_block_ulong_fprunsigned_longf(FILE *stream, const cml_block_ulong_t *b, const unsigned long *format);
...
int cml_block_ulong_raw_fprunsigned_longf(FILE *stream, const unsigned long *b, const size_t n, const size_t stride, const unsigned long *format);
