#ifndef CML_H
#error "Never use <cml/include/math/functions/generic.h> directly; include <cml.h> instead."
#endif
...
#else
        #error "<cml/include/math/functions/generic.h> not implemented for this compiler"
#endif
#endif
