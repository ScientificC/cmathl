...
install from source code: First install the libreries [ScientificC/errno](https://github.com/ScientificC/errno) and [ScientificC/vector](https://github.com/ScientificC/vector). [_How to install the_dependencies_](#dependencies)?
